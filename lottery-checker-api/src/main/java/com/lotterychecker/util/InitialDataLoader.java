...
public class InitialDataLoader implements ApplicationRunner {
	...
	if ("create".equalsIgnoreCase(ddlAutoProp)) {
	    ...
	    User admin = userRepository.save(new User("Admin", "admin", "admin", "admin", true));
	    ...
	    Game quina = gameRepository.save(new Game("quina", 5, 15, 80, (long) 0, true));
	    ...
	    betRepository
	            .save(new Bet(true, BigDecimal.ZERO, "1,3,5,6,8,9,10,13,14,16,18,20,21,22,24", admin.getId(), lotofacil.getId(), LocalDate.of(2021, 1, 1)));
